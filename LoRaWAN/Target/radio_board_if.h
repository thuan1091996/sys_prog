...
#define RF_SW_VCTRL1_PIN                          	GPIO_PIN_8
#define RF_SW_VCTRL1_GPIO_PORT                    	GPIOB
#define RF_SW_VCTRL1_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOB_CLK_ENABLE()
#define RF_SW_VCTRL1_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOB_CLK_DISABLE()


#define RF_SW_VCTRL2_PIN                          	GPIO_PIN_13
#define RF_SW_VCTRL2_GPIO_PORT                    	GPIOB
#define RF_SW_VCTRL2_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOC_CLK_ENABLE()
#define RF_SW_VCTRL2_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOC_CLK_DISABLE()
